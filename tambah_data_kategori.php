...
if( !isset($_SESSION['login']) ){
  ...
  exit;
    ...
    if(isset($_POST['tombol_submit'])){
        if(tambah_data_kategori($_POST) > 0){
            echo "
                <script>
    ...
    <nav class="navbar navbar-expand-lg navbar-light white bg-primary">
        <div class="container">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link active text-white" aria-current="page" href="kategori.php">Data Kategori</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-md-6">
                ...
                <!-- <form action="" method="POST"> -->
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" " placeholder="Nama Kategori" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
