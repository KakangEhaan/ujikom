            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">kakang <P class="R H"></P></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Kakang Sarkehan - Web Developer
                    <small>commander Naquinity since August 2024</small>
                  </p>
                </li>
                <!--end::User Image-->
            ...
            <!-- =============== ISI TABEL ADA DI SINI =============== -->
                ...
                <?php foreach($buku as $data): ?>
                  <tr>
                      ...
                      <td> <?= $data['penulis'] ?> </td>
                      <td><img src="img/<?php echo $data['gambar']; ?>" width="70"></td>
